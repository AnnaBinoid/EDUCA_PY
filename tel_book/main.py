...
# # with open('book.txt', 'w', encoding= 'utf-8') as f: # Открыть файл, записать в него данные
# #     f.write('ФИО | Номер телефона')

# # with open('book.txt', 'a', encoding= 'utf-8') as f: # Открыть файл, Дозаписать в него данные
# #     f.write('\nФИО1  |  Номер телефона1')

# # with open('book.txt', 'r', encoding= 'utf-8') as f: # Открыть файл, извлечь данные
# #     print(f.read())
